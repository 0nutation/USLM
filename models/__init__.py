...
from uslm.models.valle import VALLE, VALLF
from uslm.models.uslm import USLM
...
def add_model_arguments(parser: argparse.ArgumentParser):
    parser.add_argument(
        ...
        type=str,
        default="USLM",
        help="USLM, VALL-E, VALL-F, Transformer.",
    )
    parser.add_argument(
        "--decoder-dim",
        type=int,
...
def get_model(params: AttributeDict) -> nn.Module:
    if params.model_name.lower() in ["USLM", "uslm"]:
        model = USLM(
            params.decoder_dim,
            params.nhead,
    ...
    elif params.model_name.lower() in ["vall-f", "vallf"]:
        model = VALLF(
            params.decoder_dim,
            params.nhead,
            params.num_decoder_layers,
